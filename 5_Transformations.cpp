...
void Init()
{
	...
	window = SDL_CreateWindow("Transformations", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
	...
	LoadShader("shader/Shader4.vs", "shader/Shader4.fs");
}
...
void Update()
{
	...
	glm::mat4 trans;
	trans = glm::translate(trans, glm::vec3(num, 0.0f, 0.0f));
	trans = glm::rotate(trans, num, glm::vec3(0.0f, 0.0f, 1.0f));
	trans = glm::scale(trans, glm::vec3(num));

	glUseProgram(program);
	glUniformMatrix4fv(gTransformation, 1, GL_FALSE, glm::value_ptr(trans));
