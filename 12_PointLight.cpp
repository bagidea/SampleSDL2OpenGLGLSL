...
void Init()
{
	...
	window = SDL_CreateWindow("Point Light", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
	...
	LoadShader("source/shader/Shader5.vs", "source/shader/Shader7.fs", 0);
...
void Update()
{
	...
	glBindVertexArray(lightVAO);
		glm::mat4 light;
		light = glm::translate(light, glm::vec3(lightX+3.0f, 1.0f, lightZ+3.0f));
