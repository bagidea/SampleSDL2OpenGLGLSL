...
void Init()
{
	...
	window = SDL_CreateWindow("Camera Basic", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
...
void Update()
{
	...
	GLfloat camX = sinf(SDL_GetTicks() * 0.001f) * 5.0f;
	GLfloat camZ = cosf(SDL_GetTicks() * 0.001f) * 5.0f;
