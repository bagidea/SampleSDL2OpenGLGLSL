...
void Init()
{
	...
	window = SDL_CreateWindow("Assimp Loader and Lighting", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
	...
	shader = LoadShader("shader/Shader11.vs", "shader/Shader11.fs");
}
