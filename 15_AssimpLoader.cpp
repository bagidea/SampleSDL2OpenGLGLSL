...
void Init()
{
	...
	window = SDL_CreateWindow("Assimp Loader", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL);
	...
	shader = LoadShader("shader/Shader10.vs", "shader/Shader10.fs");
}
